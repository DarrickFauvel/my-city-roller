...
export default function Header(props: HeaderProps) {
  ...
  return (
    <header
      ...
      <span
        className={`${cormorant.className} text-white [text-shadow:_0_1px_10px_white] text-3xl sm:text-4xl font-bold sm:text-4xl hover:cursor-pointer animate-fade-in`}
